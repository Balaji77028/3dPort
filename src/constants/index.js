...
export const experiences = [
    {
        title: "React.js learner",
        company_name: "SkilledSOul",
        icon: react,
        iconBg: "#accbe1",
...
export const socialLinks = [
    ...
    },
    {
        name: 'GitHub',
        iconUrl: github,
        link: 'https://github.com/revenger77025',
    },
    {
        name: 'LinkedIn',
        iconUrl: linkedin,
        link: 'https://www.linkedin.com/in/bodicharla-balaji-9596ab274',
    },
    {
        name: 'Instagram',
        iconUrl: instagram,
        link: 'https://www.instagram.com/___the_unthinkables____97/',
    },
    {
        name: 'X(twitter)',
        iconUrl: x,
        link: 'https://twitter.com/BalajiBodichar3',
    }
];
...
export const projects = [
    {
        ...
        theme: 'btn-back-red',
        name: 'Youtube_Clone',
        description: 'built a complete clone of youtube,allowing to play and share videos',
        link: 'https://youtubeclone-theta-taupe.vercel.app/',
    },
    {
        iconUrl: threads,
        theme: 'btn-back-green',
        name: 'Functioning college website',
